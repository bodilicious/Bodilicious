...
async function generateMarkdownReport() {
    try {
        ...
        products.sort((a, b) => (a.category || '').localeCompare(b.category || '')).forEach(p => {
            ...
            md += `| \`${p.pid}\` | ${p.name} | ${p.category} | ${stockStatus} | ₹${p.price_inr || p.price} | ${p.availability} |\n`;
        });
        md += '\n';
        ...
        const reportPath = path.join('C:', 'Users', 'admin', '.gemini', 'antigravity', 'brain', '83fbfc26-ae77-4006-bfc5-ae0f375d4883', 'product_report.md');
